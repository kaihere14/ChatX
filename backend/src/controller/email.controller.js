...
export const sendForgotPasswordEmail = async (email, username, otp) => {
  ...
  try {
    const message = await resend.emails.send({
      from: "ChatX <no-reply@pawpick.store>",
      subject: "Reset Your ChatX Password 🔑",
      to: email,
      html: `
        <!DOCTYPE html>
        <html>
                ...
                <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
                  ...
                  <tr>
                    <td style="padding: 40px;">
                      ...
                      <p style="margin: 0 0 16px; font-size: 16px; line-height: 1.6; color: #4a4a4a;">
                        We received a request to reset your ChatX password. Use the OTP below to securely reset your password. This OTP will expire in <strong>5 minutes</strong>.
                      </p>
                      
                      <!-- OTP Section -->
                      <table role="presentation" style="margin: 20px 0 32px;">
                        <tr>
                          <td style="text-align: center; background-color: #f8f8f8; border-radius: 6px; padding: 20px;">
                            <span style="font-size: 28px; font-weight: 700; letter-spacing: 2px; color: #000000;">
                              ${otp}
                            </span>
                          </td>
                        </tr>
                      ...
                      <p style="margin: 0 0 24px; font-size: 16px; line-height: 1.6; color: #4a4a4a;">
                        If you did not request a password reset, please ignore this email. Your account remains safe and secure.
                      </p>
