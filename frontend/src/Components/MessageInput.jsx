...
const MessageInput = () => {
    ...
    return (
      <div className="p-2 sm:p-4 border-t sticky bottom-1 border-slate-700/50">
        {imagePreview && (
          <div className="max-w-3xl mx-auto mb-2 sm:mb-3 flex items-center">
            <div className="relative">
              ...
              <button
                onClick={removeImage}
                className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-slate-800 flex items-center justify-center text-slate-200 hover:bg-slate-700"
                type="button"
              >
        ...
        <form onSubmit={handleSendMessage} className="max-w-3xl mx-auto flex space-x-2 sm:space-x-4">
          ...
          <button
            ...
            className={`bg-slate-800/50 text-slate-400 hover:text-slate-200 rounded-lg px-3 sm:px-4 py-2 transition-colors ${
